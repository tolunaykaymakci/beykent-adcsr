      ...
      {plan == null ? (
        ...
        <View style={{alignItems:"center", width:'100%', height:'100%'}}>
          ...
          <View style={{
            ...
            elevation: 10,
              ...
              <Text style={{fontSize:13, color:"#003351"}}>
                  Bir ders programı oluşturarak kendinize günlük soru hedefleri belirleyebilirsiniz. Soru sayacı hedefinize ulaşmanıza yardımcı olacaktır.
              </Text>
              <TouchableOpacity style={{width:'100%', flexDirection:"row", alignItems:"center", justifyContent:"flex-end"}} onPress={onDayPlan} >
                <Image 
          ...
          <FlatList 
            data={plan.lessons}
            numColumns={2}
            contentContainerStyle={{width:width, justifyContent:"space-around", marginTop:20}}
            columnWrapperStyle={{justifyContent:"space-around", width:'98%', marginBottom:20}}
